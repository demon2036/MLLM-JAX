...
import sampler2 as sampler_lib


import sentencepiece as spm

from language.gemma.transformer import Transformer, TransformerConfig, PaliTransformer
from load_weight import get_pretrain_params, get_pretrain_vit_params
from vision.siglip.vit import Model
...
def _load_and_sample(
  ...
  vit_params=  get_pretrain_vit_params()
  vit_model=Model(num_classes=2048,variant="So400m/14",pool_type='none')
  ...
  transformer = PaliTransformer(gemma_2b_config)
