...
from MLLM_JAX.deprecated.utils import get_jax_mesh2, match_partition_rules, get_partition_rules_llama
...
def get_ds():
    ...
    dataloader = torch.utils.data.DataLoader(tokenized_id, batch_size=32,
                                             ...
                                             collate_fn=functools.partial(DataCollatorForSeq2Seq(tokenizer=tokenizer,
...
if __name__ == "__main__":
    ...
    state = get_model(mesh, tokenizer)
    while True:
        pass
    ...
    for i in range(epochs):
        ...
        for data in pbar:
            ...
            state, metrics = test_fn(state, data)
            # print(loss)
