...
- MiniOneRec trie constrained decode analysis for mllm-jax: `docs/sops/minionerec-trie-constrained-decode-mllm-jax.md`
- MiniOneRec SID SFT + eval (projects/minionerec/sft): `docs/sops/minionerec-sid-sft-and-eval.md`
...
- MiniOneRec official ckpt eval (pure beam vs constrained): `docs/sops/minionerec-official-ckpt-eval-beam-vs-constrained.md`
- MiniOneRec SID SFT Muon optimizer (v6e-8): `docs/sops/minionerec-sid-sft-jax-muon-optimizer-v6e-8.md`
...
- `docs/sops/minionerec-sid-sft-jax-muon-optimizer-v6e-8.md`
