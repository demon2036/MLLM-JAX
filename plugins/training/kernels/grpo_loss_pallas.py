...
def _logsumexp_stats_pallas_full_vocab(
    *,
    ...
    dim_semantics = ("parallel", "parallel", "parallel") if blocks == 1 else ("parallel", "parallel", "arbitrary")
    call = pl.pallas_call(
        ...
        compiler_params=pltpu.CompilerParams(dimension_semantics=dim_semantics),
        interpret=interpret,
        debug=bool(debug),
    )
