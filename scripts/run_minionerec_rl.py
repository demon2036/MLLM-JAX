...
def _cfg_from_dict(cfg: dict[str, Any], *, config_path: str) -> MiniOneRecRlConfig:
    ...
    data = MiniOneRecRlDataConfig(
        ...
        item_meta_path=_get_or_default(cfg, "data.item_meta_path", DEFAULT_CONFIG["data"].get("item_meta_path")),
        enable_title2sid=bool(_get_or_default(cfg, "data.enable_title2sid", DEFAULT_CONFIG["data"].get("enable_title2sid", False))),
        enable_seqtitle2sid=bool(_get_or_default(cfg, "data.enable_seqtitle2sid", DEFAULT_CONFIG["data"].get("enable_seqtitle2sid", False))),
        sample_title2sid=int(_get_or_default(cfg, "data.sample_title2sid", DEFAULT_CONFIG["data"].get("sample_title2sid", -1))),
        sample_seqtitle2sid=int(_get_or_default(cfg, "data.sample_seqtitle2sid", DEFAULT_CONFIG["data"].get("sample_seqtitle2sid", 10000))),
